...
const tracks = [
  ...
  {
    "command": "Comment ca on bute Karadoc", 
  ...
  {
    "command": "Ren dez vous a la ta verne incognito", 
  ...
  {
    "command": "a moi a lassassin", 
    "file": "./sounds/a_moi_a_lassassin.mp3"
  }, 
  {
    "command": "a mon epoque ca se faisait pas", 
  ...
  {
    "command": "a voui vous avez raison", 
  ...
  {
    "command": "ah enfin vous voila mon ami mais que se passe t il jentends crier", 
    "file": "./sounds/ah__enfin_vous_voila_mon_ami__mais_que_se_passe_t_il_jentends_crier.mp3"
  }, 
  {
    "command": "ah ah mais vous etes marteau et regardez ca ca pisse le sang", 
    "file": "./sounds/ah_ah_mais_vous_etes_marteau_et_regardez_ca_ca_pisse_le_sang.mp3"
  }, 
  {
    "command": "ah bah alors la je les attends les mecs", 
    "file": "./sounds/ah_bah_alors_la_je_les_attends_les_mecs.mp3"
  }, 
  {
    "command": "ah bah ouais mais apres il faut un peu de technique", 
    "file": "./sounds/ah_bah_ouais_mais_apres_il_faut_un_peu_de_technique.mp3"
  }, 
  {
    "command": "ah bravo bah vous parlez d un hero", 
  ...
  {
    "command": "allez boire un coup", 
    "file": "./sounds/allez_boire_un_coup.mp3"
  }, 
  {
    "command": "allez vous preparer mousaillon on largue les amarres dans une heure", 
    "file": "./sounds/allez_vous_preparer_mousaillon_on_largue_les_amarres_dans_une_heure.mp3"
  }, 
  {
    "command": "allez vous reposer vous l avez bien merite", 
  ...
  {
    "command": "arretez de parler aux gens", 
    "file": "./sounds/arretez_de_parler_aux_gens.mp3"
  }, 
  {
    "command": "arretez immediatement de me prendre pour une truite", 
  ...
  {
    "command": "attendez il faut que ca soit vrai tout ce qu on dit la", 
    "file": "./sounds/attendez_il_faut_que_ca_soit_vrai_tout_ce_qu_on_dit_la.mp3"
  }, 
  {
    "command": "attention attention a un moment il y a des granges qui vont se mettre a flamber il faudra pas demander d ou sa vient", 
  ...
  {
    "command": "au bout dun moment on a prefere plus rien dire", 
    "file": "./sounds/au_bout_dun_moment_on_a_prefere_plus_rien_dire.mp3"
  }, 
  {
    "command": "au bucher demon expie tes fautes", 
    "file": "./sounds/au_bucher_demon_expie_tes_fautes.mp3"
  }, 
  {
    "command": "au gros sel qu est ce que c est ces conneries vous me prenez pour une epaule d agneau", 
  ...
  {
    "command": "avec sa couille", 
    "file": "./sounds/avec_sa_couille.mp3"
  }, 
  {
    "command": "avez de la chance", 
  ...
  {
    "command": "bah je sais pas me lacher la grappe par exemple", 
    "file": "./sounds/bah_je_sais_pas_me_lacher_la_grappe_par_exemple.mp3"
  }, 
  {
    "command": "bah si il n y avait que les oiseaux elle est a moitie givree de toute facon on ne peut pas tout relever non plus", 
  ...
  {
    "command": "ben nous on a cru que cetait la pour faire joli", 
    "file": "./sounds/ben_nous_on_a_cru_que_cetait_la_pour_faire_joli.mp3"
  }, 
  {
    "command": "ben oui cest une rime triple blanche et seche poitrine et prairie de notre enfance", 
  ...
  {
    "command": "bien manger cest important", 
  ...
  {
    "command": "bohort arreter de vous vexer sans arret comme une grosse dinde", 
  ...
  {
    "command": "buffet a vaisselle", 
    "file": "./sounds/buffet_a_vaisselle.mp3"
  }, 
  {
    "command": "burgonde ou anglais", 
  ...
  {
    "command": "c est cotelette que vous comprenez pas", 
    "file": "./sounds/c_est_cotelette_que_vous_comprenez_pas.mp3"
  }, 
  {
    "command": "c est maintenant quil faut se secouer", 
    "file": "./sounds/c_est_maintenant_quil_faut_se_secouer.mp3"
  }, 
  {
    "command": "c est pas parce qu ils ont trahi que c est plus des allies", 
  ...
  {
    "command": "centurion caius camilus lulululu", 
  ...
  {
    "command": "cest beau quand meme", 
    "file": "./sounds/cest_beau_quand_meme.mp3"
  }, 
  {
    "command": "cest bien fait", 
    "file": "./sounds/cest_bien_fait.mp3"
  }, 
  {
    "command": "cest bien quon reste un peu dehors", 
    "file": "./sounds/cest_bien_quon_reste_un_peu_dehors.mp3"
  }, 
  {
    "command": "cest chaud quand meme", 
  ...
  {
    "command": "cest debile cette histoire", 
  ...
  {
    "command": "commencez pas a me faire chier", 
  ...
  {
    "command": "comment peut on arriver a un grade aussi eleve", 
  ...
  {
    "command": "considerer que je suis officiellement cul nu", 
    "file": "./sounds/considerer_que_je_suis_officiellement_cul_nu.mp3"
  }, 
  {
    "command": "coup de beche", 
    "file": "./sounds/coup_de_beche.mp3"
  }, 
  {
    "command": "coup de pied aux poules", 
    "file": "./sounds/coup_de_pied_aux_poules.mp3"
  }, 
  {
    "command": "crame ta famille", 
  ...
  {
    "command": "dans trois jours cest les vacances", 
    "file": "./sounds/dans_trois_jours_cest_les_vacances.mp3"
  }, 
  {
    "command": "dans trois jours ma tata elle menmene a la mer pour me noyer", 
  ...
  {
    "command": "de quoi desole excusez moi j ecoutais pas", 
    "file": "./sounds/de_quoi_desole_excusez_moi_j_ecoutais_pas.mp3"
  }, 
  {
    "command": "de tout facon on dit le nord selon comment on est tourne ca change tout", 
  ...
  {
    "command": "demi journee vous attend", 
  ...
  {
    "command": "des pedales ils disent sur le message", 
    "file": "./sounds/des_pedales_ils_disent_sur_le_message.mp3"
  }, 
  {
    "command": "des vetements", 
    "file": "./sounds/des_vetements.mp3"
  }, 
  {
    "command": "deux trous du cul soient plus efficaces qu un seul", 
    "file": "./sounds/deux_trous_du_cul_soient_plus_efficaces_qu_un_seul.mp3"
  }, 
  {
    "command": "difference concrete avec des briques", 
    "file": "./sounds/difference_concrete_avec_des_briques.mp3"
  }, 
  {
    "command": "dis donc machine si tu allais voir a la table du fond si on y ait", 
    "file": "./sounds/dis_donc_machine_si_tu_allais_voir_a_la_table_du_fond_si_on_y_ait.mp3"
  }, 
  {
    "command": "dites tirez vous", 
    "file": "./sounds/dites_tirez_vous.mp3"
  }, 
  {
    "command": "dites tout de suite que j ai des idees de tocard", 
  ...
  {
    "command": "ecoutez je comprend rien a ce que vous faites", 
  ...
  {
    "command": "elle avait choppe toutes les maladies", 
    "file": "./sounds/elle_avait_choppe_toutes_les_maladies.mp3"
  }, 
  {
    "command": "elle avait rien a y foutre deja pour commencer", 
    "file": "./sounds/elle_avait_rien_a_y_foutre_deja_pour_commencer.mp3"
  }, 
  {
    "command": "elle est ou la poulette", 
  ...
  {
    "command": "en garde espece de vieille pute degarnie", 
    "file": "./sounds/en_garde_espece_de_vieille_pute_degarnie.mp3"
  }, 
  {
    "command": "en garde ma mignone", 
  ...
  {
    "command": "essayez de faire des phrases pour vous deja", 
  ...
  {
    "command": "est ce que vous pouvez vous barrer maintenant", 
    "file": "./sounds/est-ce_que_vous_pouvez_vous_barrer_maintenant.mp3"
  }, 
  {
    "command": "est ce que peut servir elan pigeon", 
    "file": "./sounds/est_ce_que_peut_servir_elan_pigeon.mp3"
  }, 
  {
    "command": "est ce quil sait nager deja", 
  ...
  {
    "command": "exagerer non", 
    "file": "./sounds/exagerer_non.mp3"
  }, 
  {
    "command": "excusez moi hein je ne connais pas encore bien vos noms", 
    "file": "./sounds/excusez_moi_hein_je_ne_connais_pas_encore_bien_vos_noms.mp3"
  }, 
  {
    "command": "fagot fagot fagot", 
    "file": "./sounds/fagot_fagot_fagot.mp3"
  }, 
  {
    "command": "faisons table en marbre", 
  ...
  {
    "command": "faites gaffe aux pieges a loups", 
  ...
  {
    "command": "faut ce qui faut", 
    "file": "./sounds/faut_ce_qui_faut.mp3"
  }, 
  {
    "command": "faut que je retourne a la ferme de mes vieux", 
    "file": "./sounds/faut_que_je_retourne_a_la_ferme_de_mes_vieux.mp3"
  }, 
  {
    "command": "federer mes couilles", 
  ...
  {
    "command": "ferme ta gueule", 
    "file": "./sounds/ferme_ta_gueule.mp3"
  }, 
  {
    "command": "fier je vais l envoyer trois mois a poil dans la foret", 
    "file": "./sounds/fier_je_vais_l_envoyer_trois_mois_a_poil_dans_la_foret.mp3"
  }, 
  {
    "command": "fils d unijambiste", 
  ...
  {
    "command": "gigoter des miches ca donne faim", 
  ...
  {
    "command": "he les connards vous pouvez faire griller un porcelet", 
  ...
  {
    "command": "heu cest plutot des cons", 
    "file": "./sounds/heu_cest_plutot_des_cons.mp3"
  }, 
  {
    "command": "honnetement je connais pas le mot la", 
    "file": "./sounds/honnetement_je_connais_pas_le_mot_la.mp3"
  }, 
  {
    "command": "humilite infiltration", 
    "file": "./sounds/humilite_infiltration.mp3"
  }, 
  {
    "command": "ici chez les salopards", 
  ...
  {
    "command": "ils se barrent en mission pendant trois mois et ils reviennent avec une anguille", 
    "file": "./sounds/ils_se_barrent_en_mission_pendant_trois_mois_et_ils_reviennent_avec_une_anguille.mp3"
  }, 
  {
    "command": "ils sortent bien de quelques part", 
  ...
  {
    "command": "jai arrete les pronostics", 
    "file": "./sounds/jai_arrete_les_pronostics.mp3"
  }, 
  {
    "command": "jai pas envie de voir vos tronches", 
    "file": "./sounds/jai_pas_envie_de_voir_vos_tronches.mp3"
  }, 
  {
    "command": "jai rien compris", 
    "file": "./sounds/jai_rien_compris.mp3"
  }, 
  {
    "command": "jai toujours ete fascine par le monde paysan", 
  ...
  {
    "command": "la bouffe est interdite", 
    "file": "./sounds/la_bouffe_est_interdite.mp3"
  }, 
  {
    "command": "la dedans carbure", 
  ...
  {
    "command": "la monstruosite", 
    "file": "./sounds/la_monstruosite.mp3"
  }, 
  {
    "command": "la vache ca daube la dedans il y a un chat qui est creve ou quoi", 
    "file": "./sounds/la_vache_ca_daube_la_dedans_il_y_a_un_chat_qui_est_creve_ou_quoi.mp3"
  }, 
  {
    "command": "lache une caisse", 
  ...
  {
    "command": "le caca des pigeons c est caca faut pas manger", 
    "file": "./sounds/le_caca_des_pigeons_c_est_caca_faut_pas_manger.mp3"
  }, 
  {
    "command": "le graal par ci le graal par la", 
    "file": "./sounds/le_graal_par_ci_le_graal_par_la.mp3"
  }, 
  {
    "command": "le gras cest la vie", 
    "file": "./sounds/le_gras_cest_la_vie.mp3"
  }, 
  {
    "command": "le pognon ca va ca vient", 
    "file": "./sounds/le_pognon_ca_va_ca_vient.mp3"
  }, 
  {
    "command": "le poisson le petit poisson", 
    "file": "./sounds/le_poisson_le_petit_poisson.mp3"
  }, 
  {
    "command": "le prochain qui l ouvre galeres trois ans", 
  ...
  {
    "command": "mavez lair en forme", 
    "file": "./sounds/mavez_lair_en_forme.mp3"
  }, 
  {
    "command": "me parler a cette heure ci vous voulez mon pied au cul", 
  ...
  {
    "command": "mettre du beurre au fond du plat", 
    "file": "./sounds/mettre_du_beurre_au_fond_du_plat.mp3"
  }, 
  {
    "command": "mi ours mi scorpion", 
  ...
  {
    "command": "moi non plus je vois rien", 
    "file": "./sounds/moi_non_plus_je_vois_rien.mp3"
  }, 
  {
    "command": "mon frere y peut pas aller a l ecole", 
  ...
  {
    "command": "non mais je sens bien que vous essayer de me dire quelque chose", 
    "file": "./sounds/non_mais_je_sens_bien_que_vous_essayer_de_me_dire_quelque_chose.mp3"
  }, 
  {
    "command": "non psychologique c est tout ce qui est a la campagne", 
    "file": "./sounds/non_psychologique_c_est_tout_ce_qui_est_a_la_campagne.mp3"
  }, 
  {
    "command": "non taisez vous", 
  ...
  {
    "command": "oh ca fait rien", 
    "file": "./sounds/oh_ca_fait_rien.mp3"
  }, 
  {
    "command": "oh cest la vacherie ca", 
    "file": "./sounds/oh_cest_la_vacherie_ca.mp3"
  }, 
  {
    "command": "oh et puis j en ai marre", 
  ...
  {
    "command": "oh putain oui", 
    "file": "./sounds/oh_putain_oui.mp3"
  }, 
  {
    "command": "ok on va arreter le tire avec les defis", 
  ...
  {
    "command": "ouais ca aussi", 
    "file": "./sounds/ouais_ca_aussi.mp3"
  }, 
  {
    "command": "ouais cest mortel ouais", 
  ...
  {
    "command": "oui enfin je me comprends", 
    "file": "./sounds/oui_enfin_je_me_comprends.mp3"
  }, 
  {
    "command": "oui et ben moi je vous donne lordre de lui preter votre corne parce que quand on est gentil on prete", 
    "file": "./sounds/oui_et_ben_moi_je_vous_donne_lordre_de_lui_preter_votre_corne_parce_que_quand_on_est_gentil_on_prete.mp3"
  }, 
  {
    "command": "oui oh ca va je connais le couplet on est fatigue on est fatigue vous me le cancane depuis midi", 
    "file": "./sounds/oui_oh_ca_va_je_connais_le_couplet_on_est_fatigue_on_est_fatigue_vous_me_le_cancane_depuis_midi.mp3"
  }, 
  {
    "command": "oui ou une fissure a colmater dans un muret", 
  ...
  {
    "command": "parce que la quite a se faire reperer on prendrait moins de risque a faire venir un orchestre", 
    "file": "./sounds/parce_que_la_quite_a_se_faire_reperer_on_prendrait_moins_de_risque_a_faire_venir_un_orchestre.mp3"
  }, 
  {
    "command": "parfaitement antipathique", 
    "file": "./sounds/parfaitement_antipathique.mp3"
  }, 
  {
    "command": "parle de travers cureton", 
  ...
  {
    "command": "pas de quoi en chier une galette", 
    "file": "./sounds/pas_de_quoi_en_chier_une_galette.mp3"
  }, 
  {
    "command": "pas du tout les lapins les lapins c est gentil", 
    "file": "./sounds/pas_du_tout_les_lapins_les_lapins_c_est_gentil.mp3"
  }, 
  {
    "command": "pas envie de participer", 
    "file": "./sounds/pas_envie_de_participer.mp3"
  }, 
  {
    "command": "pas foutu de savoir son nom", 
  ...
  {
    "command": "pauvre conne", 
    "file": "./sounds/pauvre_conne.mp3"
  }, 
  {
    "command": "pays de galles independant", 
  ...
  {
    "command": "petit a petit vers plus dautonomie", 
    "file": "./sounds/petit_a_petit_vers_plus_dautonomie.mp3"
  }, 
  {
    "command": "petit ton decale", 
    "file": "./sounds/petit_ton_decale.mp3"
  }, 
  {
    "command": "petite corne", 
  ...
  {
    "command": "pfff c est pour ca que je pane rien aux livres moi ca veut pas dire ce qu il y a marque", 
  ...
  {
    "command": "politique de l autruche", 
    "file": "./sounds/politique_de_l_autruche.mp3"
  }, 
  {
    "command": "pour le detail je sais pas", 
    "file": "./sounds/pour_le_detail_je_sais_pas.mp3"
  }, 
  {
    "command": "pour savoir si il va y avoir du vent", 
  ...
  {
    "command": "quest ce que vous attendez pour la couper", 
    "file": "./sounds/quest_ce_que_vous_attendez_pour_la_couper.mp3"
  }, 
  {
    "command": "quest ce qui est petit et marron", 
  ...
  {
    "command": "rangez moi ca debile la table ronde c est pas une fete de l artisanat", 
  ...
  {
    "command": "regardez moi ce petit navet", 
    "file": "./sounds/regardez_moi_ce_petit_navet.mp3"
  }, 
  {
    "command": "regardez moi cette meule", 
  ...
  {
    "command": "restez pas plante la comme un cepe", 
  ...
  {
    "command": "rien a carer", 
    "file": "./sounds/rien_a_carer.mp3"
  }, 
  {
    "command": "rien a carrer", 
    "file": "./sounds/rien_a_carrer.mp3"
  }, 
  {
    "command": "rooo bon alors on fait venir les poulettes ou quoi", 
  ...
  {
    "command": "sans blague ya pas dla gourdasse", 
    "file": "./sounds/sans_blague_ya_pas_dla_gourdasse.mp3"
  }, 
  {
    "command": "sans deconner", 
    "file": "./sounds/sans_deconner.mp3"
  }, 
  {
    "command": "sans etre totalement repoussant il n y a pas de quoi bousculer une charette", 
    "file": "./sounds/sans_etre_totalement_repoussant_il_n_y_a_pas_de_quoi_bousculer_une_charette.mp3"
  }, 
  {
    "command": "scorpion entoure par le feu", 
  ...
  {
    "command": "si j etais tombe sur un faisant", 
    "file": "./sounds/si_j_etais_tombe_sur_un_faisant.mp3"
  }, 
  {
    "command": "si vous etes vendeur", 
    "file": "./sounds/si_vous_etes_vendeur.mp3"
  }, 
  {
    "command": "signe de vouloir discuter", 
    "file": "./sounds/signe_de_vouloir_discuter.mp3"
  }, 
  {
    "command": "sils sont equidistants on peut reperer le dragon", 
    "file": "./sounds/sils_sont_equidistants_on_peut_reperer_le_dragon.mp3"
  }, 
  {
    "command": "simple deduction mon oncle", 
    "file": "./sounds/simple_deduction_mon_oncle.mp3"
  }, 
  {
    "command": "sinon ce que je peux vous proposer on attache le condamne", 
  ...
  {
    "command": "sire vous me flattez", 
    "file": "./sounds/sire_vous_me_flattez.mp3"
  }, 
  {
    "command": "sortez vous les doigts du cul", 
  ...
  {
    "command": "soupcon gros nul", 
    "file": "./sounds/soupcon_gros_nul.mp3"
  }, 
  {
    "command": "sourire comme des glands", 
    "file": "./sounds/sourire_comme_des_glands.mp3"
  }, 
  {
    "command": "stand de crepes", 
    "file": "./sounds/stand_de_crepes.mp3"
  }, 
  {
    "command": "sur de son coup", 
    "file": "./sounds/sur_de_son_coup.mp3"
  }, 
  {
    "command": "tais toi ta gueule tais toi", 
  ...
  {
    "command": "tatan elle fait des flans", 
  ...
  {
    "command": "toujours se plaindre pequenauds", 
    "file": "./sounds/toujours_se_plaindre_pequenauds.mp3"
  }, 
  {
    "command": "tout dans le furtif", 
    "file": "./sounds/tout_dans_le_furtif.mp3"
  }, 
  {
    "command": "tout le monde s en branle moi le premier", 
  ...
  {
    "command": "tu la fermes definitivement", 
    "file": "./sounds/tu_la_fermes_definitivement.mp3"
  }, 
  {
    "command": "un bon quart dheure", 
    "file": "./sounds/un_bon_quart_dheure.mp3"
  }, 
  {
    "command": "un genre cake", 
    "file": "./sounds/un_genre_cake.mp3"
  }, 
  {
    "command": "un jour je vais lui fumer sa gueule a ce connard", 
    "file": "./sounds/un_jour_je_vais_lui_fumer_sa_gueule_a_ce_connard.mp3"
  }, 
  {
    "command": "un plan d attaque minute au poil de fion", 
    "file": "./sounds/un_plan_d_attaque_minute_au_poil_de_fion.mp3"
  }, 
  {
    "command": "une claque dans le museau vous repondez", 
    "file": "./sounds/une_claque_dans_le_museau_vous_repondez.mp3"
  }, 
  {
    "command": "une fois a une execution je m approche d une fille", 
  ...
  {
    "command": "venir foutre votre merde", 
    "file": "./sounds/venir_foutre_votre_merde.mp3"
  }, 
  {
    "command": "voeux de pauvrete jarrivais pas a concilier", 
    "file": "./sounds/voeux_de_pauvrete_jarrivais_pas_a_concilier.mp3"
  }, 
  {
    "command": "voila cest pro", 
    "file": "./sounds/voila_cest_pro.mp3"
  }, 
  {
    "command": "voila passez moi la canne a peche", 
    "file": "./sounds/voila_passez_moi_la_canne_a_peche.mp3"
  }, 
  {
    "command": "votre existence est merdique", 
